...
internal static class BehaviorScenarios
{
    ...
    public static bool RunAll()
    {
        ...
        ok &= Run("Spotify action recovers monitor after late startup", ScenarioStartupRecovery);
    ...
    private static bool ScenarioStartupRecovery()
    {
        ...
        return c.Running && c.RecoveryAttempts == 1 && c.Nexted &&
               !TryFind(t.Out, "showAlert", out _);
    }
